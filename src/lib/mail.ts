...
export function sendMail(email: string, name: string, message: string, fields?: { [key: string]: string }, subject?: string) {
  ...
  let html = `<p><b>New form submission from:</b><br/><span style="font-size: 1.5em; font-weight: bold;">${name} &lt;${email}&gt;</span></p><br/><br/><h3 style="font-size: 24px; line-height: 1.5em;">Message:</h3><hr style="border: 0; height: 3px; background: #999" /><p>${message}</p>`
  let text = `New form submission from:\n${name} <${email}>\n\nMessage:\n${message}\n`

  if (fields && Object.keys(fields).length > 0) {
    html += '<br/><br/><h3 style="font-size: 24px; line-height: 1.5em;">Fields:</h3><hr style="border: 0; height: 3px; background: #999" />'
